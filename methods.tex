...
\begin{table}[htbp]
  \begin{tabular}{rllll} %{\centering\arraybackslash}p{2cm}>{\centering\arraybackslash}p{5cm}>{\centering\arraybackslash}p{9cm}}
    \hline
...
% fleet size from isl numbers:
% [where are these from? source them]
% passenger: 600
% high-speed: 3000
